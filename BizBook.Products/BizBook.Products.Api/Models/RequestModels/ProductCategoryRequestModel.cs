...
namespace BizBook.Products.Api.Models.RequestModels
{
    public class ProductCategoryRequestModel : RequestModel<ProductCategory>
    {
        ...
        public override Expression<Func<ProductCategory, DropdownViewModel<ProductCategory, TV>>> Dropdown<TV>()
        {
            return x => new DropdownViewModel<ProductCategory, TV>()
            {
                Id = x.Id,
                Text = x.Name,
                Data = x.ToViewModel<ProductCategory, TV>()
            };
        }
    }
}